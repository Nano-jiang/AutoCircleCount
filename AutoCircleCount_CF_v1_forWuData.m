%% AutoCircleCount_CF_v1_forWuData
...
% adjusted_angles = theta_deg + 45; % 奖励点在右上角
adjusted_angles = theta_deg - 45; % 奖励点在右下角
...
filename = 'FrameCount2.xlsx';

% 写入文件
writematrix(FrameCount, filename);
fprintf('文件成功保存至: FrameCount2.xlsx\n');
